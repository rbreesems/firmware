...
#define MESHTASTIC_HEADER_LENGTH 20    // increased by 4 bytes
...
#define PACKET_FLAGS_WANT_ACK_MASK 0x08
#define PACKET_FLAGS_VIA_MQTT_MASK 0x10
#define PACKET_FLAGS_HOP_LIMIT_MASK 0x1F
#define PACKET_FLAGS_HOP_START_MASK 0x1F
 ...
 * 
 * This header implementation is not compatible with standard Mestastic packets and is intended for a
...
typedef struct {
     ...
     * Usage of flags:
     *
     * The new implementation always the old hop_limit bits to 1, and old hop_start to 0.
     **/
    uint8_t flags;
